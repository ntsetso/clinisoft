...
import clinisoft.services.SidebarPage;
import clinisoft.interfaces.SidebarPageConfig;
...
public class SidebarPageConfigImpl implements SidebarPageConfig{
	...
	public SidebarPageConfigImpl(){		
		...
		pageMap.put("fn1",new SidebarPage("fn1","Profile (MVC)","/imgs/fn.png","/patcher/npaciente.zul"));
//		pageMap.put("fn2",new SidebarPage("fn2","Profile (MVVM)","/imgs/fn.png","/chapter5/profile-mvvm.zul"));
		pageMap.put("fn3",new SidebarPage("fn3","Todo List (MVC)","/imgs/fn.png","/patcher/todolist.zul"));
